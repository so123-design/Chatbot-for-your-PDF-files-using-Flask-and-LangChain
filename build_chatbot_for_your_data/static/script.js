...
const populateBotResponse = async (userMessage) => {
  ...
  if (isFirstMessage) {
    response = { botResponse: "Hello there! 😊 I'm your friendly 📊 data assistant, ready to answer any questions about your data. 📈✨ Could you please upload a 📄 PDF file for me to analyze? 🔍📂"};
    uploadButtonHtml = `
